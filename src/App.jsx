            ...
            <div style={{ marginBottom: '2rem' }}>
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--text-secondary)' }}>İstanbul, Türkiye</p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <a href="mailto:ornek@email.com" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>ornek@email.com</a>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <a href="tel:+905555555555" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>+90 555 555 5555</a>
                </div>
              </div>
            </div>
